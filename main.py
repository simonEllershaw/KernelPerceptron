...
def main():
    ...
    for iteration in range(number_iterations):
        ...
        # Init models
        kernel_perceptron = MultiClassKernelPerceptron(kernelFunctions.dot_product)
        vanilla_perceptron = MultiClassKernelPerceptron(kernelFunctions.polynomial_kernel, 3)
        ...
        t3 = time.time()
        print("Train SVM Perceptron")
        svm.train(data["images_train"], data["labels_train"])
        t4 = time.time()
        print("Train CNN Perceptron")
        ...
        t3 = time.time()
        print("Predict SVM Perceptron")
        y_pred_svm = svm.predict(data["images_test"])
        t4 = time.time()
        print("Predict CNN Perceptron")
